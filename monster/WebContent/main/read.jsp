...
<body>
	...
	<table id="cell1">
		...
		<tr>
			<td id="con" colspan="2"><%=board.getContent()%></td>
		</tr>
	</table>
	...
	<div>
	<fieldset>
	<form action="reple.jsp?num=<%=num%>" method="post" id="vv">
		<textarea name="content" rows="5" cols="100" id="cont"></textarea><br>
					...
					<table id="re">
						...
						<%
							if(id == null){
								...
								if(id.equals(re.getId()) || id.equals("admin")){
									%>
