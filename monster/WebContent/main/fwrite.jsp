...
<body>
		...
		<div id=sss>
			<form action="loginPro.jsp" method="post" id="login">
				...
				아이디 : <input type="text" name="id" /> 비번 : <input type="password"
					...
					class="btn" class="btn"> <input type="button" value="회원가입" class="btn" onclick="location.href='join.jsp'">
				<%
					} else {
				%>
	...
	<div id="wt">
	<form action="fwritePro.jsp" method="post" name="frm"
		...
		<input type="submit" value="작성하기" class="btn"> <input type="reset"
			...
			onclick="location.href='fileupload.jsp'" class="btn">
	</form>
	</div>
	<footer>
		<br> <br>
